...
def Model_Creation(model, Renewable_Penetration,Battery_Independency):
    ...
    model.Energy_Demand = Param(model.scenarios, model.years, model.user_types, model.periods, 
    ...
    model.Battery_Replacement_Cost_Act = Var(model.scenarios,within=NonNegativeReals)
